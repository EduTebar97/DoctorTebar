  ...
  return (
    <>
      ...
      <form className="editor-form" onSubmit={submit}>
        <label>Titulo del sitio<input value={form.siteTitle ?? ""} onChange={(e) => setForm({ ...form, siteTitle: e.target.value })} /></label>
        <label>Hero<input value={form.heroTitle ?? ""} onChange={(e) => setForm({ ...form, heroTitle: e.target.value })} /></label>
        ...
        <label className="span-2">Sobre mi<textarea rows={6} value={form.aboutText ?? ""} onChange={(e) => setForm({ ...form, aboutText: e.target.value })} /></label>
