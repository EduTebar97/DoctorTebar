export function AboutPage() {
  return (
    <section className="section prose-page">
      ...
      <ul>
        <li>Metodologia clinica, causalidad y modelos predictivos.</li>
        <li>STROBE, TRIPOD+AI, CONSORT, PRISMA y RECORD.</li>
        <li>Analisis en STATA 17 y flujos reproducibles.</li>
        <li>Revision metodologica de articulos y protocolos.</li>
      </ul>
    </section>
  );
}
